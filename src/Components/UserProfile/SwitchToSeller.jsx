...
const SwitchToSeller = () => {
  ...
  return (
    ...
    {askToSwitch && <p className="">You are not a vendor. Do you want to switch?</p>}
  {alreadyAVendor && role=='vendor' && <p className="">You are already a vendor! No need to switch.</p>}
  {askToSwitch && (
   ...
   {!alreadyAVendor && (
    ...
    {switchSuccessful && (
      <Modal modalText="Switched To Vendor Successfully!" buttonText="Ok" closeModal={closeModal} />
    )}
    {becomeClientSuccess && (
      <Modal modalText="You are Now A Vendor Successfully!" buttonText="Ok" closeModal={closeModal} />
    )}
    {alreadyAVendor && (
      <Modal
