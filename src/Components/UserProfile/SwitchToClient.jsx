...
const SwitchToClient = () => {
    ...
    return (
      <div>
        ...
        {askToSwitch && <p className="">You are not a client. Do you want to switch?</p>}
      {alreadyAclient && role=='client' && <p className="">You are already a client! No need to switch.</p>}
      {askToSwitch && (
        <button type="button" className="saveBtns updateBtn" onClick={switchToClient}>
          Switch To Client
        </button>
      )}
       {!alreadyAclient && (
        <>        <p className="">Not A Client? Become One</p>
        <button type="button" className="saveBtns updateBtn" onClick={becomeClient}>
        Become A Client
      </button>
      </>
        ...
        {switchSuccessful && (
          <Modal modalText="Switched To Client Successfully!" buttonText="Ok" closeModal={closeModal} />
        )}
        {becomeClientSuccess && (
          <Modal modalText="You are Now A Client Successfully!" buttonText="Ok" closeModal={closeModal} />
        )}
        {alreadyAclient && (
          <Modal
