...
const AdminAddUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorText("An error occurred while creating the user. Please try again.");
      setErrorModal(true);
    }
  };
  ...
  return (
    <div className="adminAddUser">
      ...
      <input type="text" className="addUserInput"   onChange={(e) => setFirstName(e.target.value)}/>
      </div>
      <div>
      <p className="descText"> Last Name : </p>
      <input type="text" className="addUserInput"  onChange={(e) => setLastName(e.target.value)} />
      </div>
      </div>
      <p className="descText">Email : </p>
      <input type="text" className="addUserInput"    onChange={(e) => setEmail(e.target.value)}
              required />
      <p className="descText">Password : </p>
      <input type="password" className="addUserInput"  onChange={(e) => setPassword(e.target.value)} />

      <p className="descText">Phone Number: </p>
      <input type="number" className="addUserInput" onChange={(e) => setPhoneNumber(e.target.value)} />
   ...
   {/* Success Modal */}
   {successModal && (
        <Modal modalText={succesText} buttonText="Start Browsing" closeModal={closeModal}/>
